...
from sensor_data.models import HistoricalPrecipitation, ForecastedPrecipitation, TreeMoistureReading, Device, ElectricalResistanceReading, TreeHealthReading, WeatherData, SoilMoistureReading, pHReading, waterLevelReading
